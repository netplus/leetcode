...
//
// 5. 专项算法｜有序数组分割二分：搜索一条让左右数量平衡且值域合法的切线
//   到这里才需要给这套规律命名：本题对应“有序数组分割二分：搜索一条让左右数量平衡且值域合法的切线”。通用机制见 docs/algorithms/binary-search.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
