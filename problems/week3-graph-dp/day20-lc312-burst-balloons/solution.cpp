...
//
// 5. 专项算法｜区间 DP：把难确定的“先戳谁”反过来改成邻居固定的“最后戳谁”
//   到这里才需要给这套规律命名：本题对应“区间 DP：把难确定的“先戳谁”反过来改成邻居固定的“最后戳谁””。通用机制见 docs/algorithms/dynamic-programming.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
