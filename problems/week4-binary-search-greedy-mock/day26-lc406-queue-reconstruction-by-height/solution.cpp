...
//
// 4. 从具体问题抽象规律
//   这类贪心的核心是先找“谁的决定不会被后续弱对象影响”。
//
// 5. 专项算法｜约束支配顺序：高个先固定，再按 k 插入
//   到这里才需要给这套规律命名：本题对应“约束支配顺序：高个先固定，再按 k 插入”。通用机制见 docs/algorithms/greedy.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
