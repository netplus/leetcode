...
//
// 5. 专项算法｜旋转边界二分：用右端锚点判断 middle 在断点哪一侧
//   到这里才需要给这套规律命名：本题对应“旋转边界二分：用右端锚点判断 middle 在断点哪一侧”。通用机制见 docs/algorithms/binary-search.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
