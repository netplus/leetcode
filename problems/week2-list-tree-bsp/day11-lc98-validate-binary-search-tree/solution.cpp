...
//
// 6. 专项算法｜BST 全局约束下传：每深入一层，就把合法值域收紧成更小的开区间
//   到这里才需要给这套规律命名：本题对应“BST 全局约束下传：每深入一层，就把合法值域收紧成更小的开区间”。通用机制见 docs/algorithms/tree-traversal.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 7. 核心算法
