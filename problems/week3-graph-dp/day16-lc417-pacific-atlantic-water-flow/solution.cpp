...
//
// 5. 专项算法｜反向多源可达性：把“每个格子能否到终点”改成“终点能反向到哪些格子”
//   到这里才需要给这套规律命名：本题对应“反向多源可达性：把“每个格子能否到终点”改成“终点能反向到哪些格子””。通用机制见 docs/algorithms/graph-search-toposort.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
