...
//
// 4. 从具体问题抽象规律
//   与 LC-23 一样，堆只暴露当前最关键边界；区别是 LC-23 维护多个来源的最小 frontier，LC-295 维护一个动态全体的中间分割线。
//
// 5. 专项算法｜双堆动态分割：持续维护有序序列中间边界
//   到这里才需要给这套规律命名：本题对应“双堆动态分割：持续维护有序序列中间边界”。通用机制见 docs/algorithms/heap-topk.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
