...
//
// 5. 专项算法｜自底向上归并排序：把 LC-21 的有序链合并扩展成长度 1、2、4... 的有序段
//   到这里才需要给这套规律命名：本题对应“自底向上归并排序：把 LC-21 的有序链合并扩展成长度 1、2、4... 的有序段”。通用机制见 docs/algorithms/linked-list-pointer.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 6. 核心算法
