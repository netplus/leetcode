...
//
// 5. 必要背景知识
//   “每一步跳到当前能到达的最远下标”看起来很贪心，但它不是 LC-45 的正确贪心。
//
//   反例：nums=[2,3,1,1,4]。
...
//
// 6. 专项算法｜贪心分层：把 Jump Game 的可达前沿升级成隐式 BFS 层
//   到这里才需要给这套规律命名：本题对应“贪心分层：把 Jump Game 的可达前沿升级成隐式 BFS 层”。通用机制见 docs/algorithms/greedy.md；回到本题时只保留与当前题意直接相关的状态、边界和更新顺序。
//
// 7. 核心算法
